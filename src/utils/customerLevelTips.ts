...
export const CUSTOMER_LEVEL_TIPS: Record<string, CustomerLevelTip> = {
  AA: {
    ...
    smallScaleBusiness: '1、忠实客户：合作年限长、续费率高、沟通顺畅配合度高。\n2、客户购买增值服务的频率多、金额高（变更、审计报告）、转介绍率高。\n3、开票量/凭证量多、银行流水笔数多',
    generalTaxpayerFee: '5500及以上',
    generalTaxpayerBusiness: '1、忠实客户：合作年限长、续费率高、沟通顺畅配合度高、税款缴纳及时\n2、客户购买增值服务的频率多、金额高（变更、审计报告）、转介绍率高。\n3、①账务处理难度大（特殊行业、企业规模大）\n②客户账务要求高：有特殊资产、复杂成本核算、研发费用加计扣除、政府补助等。'
  },
  AB: {
    level: 'AB',
    smallScaleFee: '2000及以上',
    smallScaleBusiness: '1、稳定客户：续费稳定，偶有降价\n2、日常业务稳定，税款缴纳及时\n3、账务处理：开票稳定、销售品种单一',
    generalTaxpayerFee: '5500及以上',
    generalTaxpayerBusiness: '1、稳定客户：续费稳定，偶有降价\n2、日常业务稳定，税款缴纳及时\n3、账务处理：开票稳定、销售品种单一'
  },
  AC: {
    level: 'AC',
    smallScaleFee: '2000及以上',
  ...
  AD: {
    level: 'AD',
    smallScaleFee: '2000及以上',
    smallScaleBusiness: '1、有过逾期申报、漏报、错报、被税务机关处罚或稽查的记录。\n2、不开票，没业务，零申报\n3、续费困难、沟通联系困难。\n4、客户税款认知程度低，缴税困难。\n5、未购买增值服务',
    generalTaxpayerFee: '5500及以上',
    generalTaxpayerBusiness: '1、有过逾期申报、漏报、错报、被税务机关处罚或稽查的记录。\n2、不开票，没业务，零申报\n3、续费困难、沟通联系困难。\n4、客户税款认知程度低，缴税困难。\n5、未购买增值服务'
  },
  BA: {
    level: 'BA',
