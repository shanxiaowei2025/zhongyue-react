...
import { Card, Button, Typography, Descriptions, Spin, Tag, Space, Timeline, Image } from 'antd'
import {
  ArrowLeftOutlined,
  CalendarOutlined,
  BuildOutlined,
...
const FinancialSelfInspectionDetail: React.FC = () => {
  ...
  // 使用统一的hook获取数据
  const { data, loading, error } = useSubmittedInspectionDetail(id ? Number(id) : null)
