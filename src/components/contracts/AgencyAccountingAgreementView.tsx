        ...
        {DECLARATION_SERVICE_OPTIONS.map((option, index) => {
          ...
          return (
            <div key={index} className={styles.serviceItem}>
              ...
              ></span>
              <span className={styles.serviceLabel}>{option.label}</span>
            </div>
          )
        })}
      </div>
          ...
          <div className={styles.entrustmentPeriod}>
            <div className={styles.entrustmentText}>
              ...
              <span className={styles.dateValue}>
                {entrustmentStartDate ? dayjs(entrustmentStartDate).format('YYYY年MM月') : '___'}
              </span>
              至
              <span className={styles.dateValue}>
                {entrustmentEndDate ? dayjs(entrustmentEndDate).format('YYYY年MM月') : '___'}
              </span>
              期间内的经济业务进行代理记账。
            </div>
          </div>
